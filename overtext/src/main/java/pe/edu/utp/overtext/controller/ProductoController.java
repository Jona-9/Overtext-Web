 ...
 *
 * <p>El parámetro {@code id} es el identificador del producto (color/slug).
 * En el Sprint 3, {@code ProductoService} proveerá los datos reales;
 * por ahora el JS del cliente ({@code tienda.js}) lee del array en memoria.
 *
...
public class ProductoController {
    ...
    public String detalle(@PathVariable String id) {
